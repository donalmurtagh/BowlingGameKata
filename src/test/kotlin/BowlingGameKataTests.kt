...
//    private fun processGame(game: Array<Int>): Int = BowlingGameJava().processGame(game.toMutableList())

    private fun processGame(game: List<Int>): Int = BowlingGameKotlin().processGame(game)
